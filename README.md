# UMKM Basic Management - Mie Arok Bang Hen Singkawang 🍜

A Single Page Application (SPA) designed to help Mie Arok Bang Hen manage customer orders efficiently. Customers can browse the menu and send their orders directly via WhatsApp, while the admin can track and manage these orders through a secure, real-time dashboard.
...
*   **Admin Dashboard:**
    ...
    *   Basic CRUD operations for managing Orders.
    *   Secure authentication for the admin.
